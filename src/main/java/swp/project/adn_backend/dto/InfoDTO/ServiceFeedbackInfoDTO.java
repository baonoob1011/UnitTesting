...
public class ServiceFeedbackInfoDTO {
    long serviceId;
    String serviceName;
    String description;
    private ServiceType serviceType;
    private String image;
    public ServiceFeedbackInfoDTO() {
    }

    public ServiceFeedbackInfoDTO(long serviceId, String serviceName, String description, ServiceType serviceType, String image) {
