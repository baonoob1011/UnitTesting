...
public class OrderInfoResponseDTO {
    ...
    public OrderInfoResponseDTO() {
    }

    public OrderInfoResponseDTO(long paymentId, double amount, PaymentMethod paymentMethod, PaymentStatus getPaymentStatus, LocalDate transitionDate) {
